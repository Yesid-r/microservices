...
import com.example.orders_service.model.dtos.*;
...
public class OrderService {
    ...
    public void placeOrder(OrderRequest orderRequest){
        ...
        if (result != null && !result.hasErrors()) {
            ...
            order.setOrderItems(orderRequest.getOrderItems().stream()
                    .map(orderItemRequest -> mapOrderItemRequestOrderItem(orderItemRequest, order))
                    .toList()
            );
    ...
    private OrderItems mapOrderItemRequestOrderItem(OrderItemRequest orderItemRequest, Order order) {
